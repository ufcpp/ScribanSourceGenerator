...
public class ScribanSourceGenerator : IIncrementalGenerator
{
    ...
    private void Init(IncrementalGeneratorPostInitializationContext context)
    {
        context.AddSource("Attributes.cs", Source("""
                ...
                [global::System.Diagnostics.Conditional("TEXT_TEMPLATE_COMPILE_TIME_ONLY")]
                [global::System.AttributeUsage(global::System.AttributeTargets.Class | global::System.AttributeTargets.Struct, Inherited = false, AllowMultiple = true)]
                internal sealed class ClassMemberAttribute : global::System.Attribute
                {
